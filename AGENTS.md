...
C# (.NET) demo app for Deepgram Text-to-Speech.
...
```
feat(csharp-text-to-speech): add diarization support
fix(csharp-text-to-speech): resolve WebSocket close handling
refactor(csharp-text-to-speech): simplify session endpoint
